  ...
  fab.addEventListener('mouseover', function () {
    ...
    if (_isClassic) {
      if (_fabLogoDiv) {
        ...
        _fabLogoDiv.style.boxShadow = '0 0 20px rgba(196,126,90,0.6), 0 14px 36px rgba(0,0,0,0.55)';
  ...
  fab.addEventListener('mouseout', function () {
    ...
    if (_isClassic) {
      if (_fabLogoDiv) {
        ...
        _fabLogoDiv.style.boxShadow = '0 0 22px rgba(196,126,90,0.65), 0 8px 28px rgba(0,0,0,0.55)';
  ...
  function buildClassicFab(logoUrl, brandColour) {
    ...
    if (_fabLogoUrl) {
      ...
      Object.assign(_fabLogoDiv.style, {
        ...
        boxShadow:       '0 0 22px rgba(196,126,90,0.65), 0 8px 28px rgba(0,0,0,0.55)',
        pointerEvents:   'none',
