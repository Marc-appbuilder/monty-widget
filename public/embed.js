  ...
  fab.addEventListener('mouseover', function () {
    ...
    if (_isClassic) {
      if (_fabLogoDiv) {
        ...
        _fabLogoDiv.style.boxShadow = '0 0 0 3px #c47e5a, 0 14px 36px rgba(0,0,0,0.7)';
  ...
  fab.addEventListener('mouseout', function () {
    ...
    if (_isClassic) {
      if (_fabLogoDiv) {
        ...
        _fabLogoDiv.style.boxShadow = '0 0 0 3px #c47e5a, 0 8px 28px rgba(0,0,0,0.6)';
  ...
  function buildClassicFab(logoUrl, brandColour) {
    ...
    if (_fabLogoUrl) {
      ...
      Object.assign(_fabLogoDiv.style, {
        ...
        boxShadow:       '0 0 0 3px #c47e5a, 0 8px 28px rgba(0,0,0,0.6)',
        pointerEvents:   'none',
